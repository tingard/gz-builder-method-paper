...
\author[T. Lingard et al.]{
  ...
  $^{5}$ESA, Leyden, NL
  $^{6}$Department, Institution, Street Address, City Postal Code, Country
  $^{7}$Department, Institution, Street Address, City Postal Code, Country
  % $^{N}$Department, Institution, Street Address, City Postal Code, Country
}
