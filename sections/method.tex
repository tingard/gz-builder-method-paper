...
\begin{itemize}
  ...
  \item Computation of stellar mass completeness limits using the method of \citet{Pozzetti2009:0907.5416v2} and limits calculated by \citet{2017MNRAS.472.2263H}, namely: \\
    $9.45 < \log(M_* / M_\odot) \le 11.05$\\ %KLM comment: Figure out how to indent these more
...
The modelling code ignores masked regions identified in the images. %KLM: Please comment on where the masks are from.
