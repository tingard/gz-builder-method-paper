...
\item A sigma image was calculated for each galaxy cutout, as described in Appendix \comment{add this in the appendix}
\end{itemize}
...
\comment{Talk about chi-square values}
