...
Before fitting for all free parameters, we fit only for the brightnesses and sizes of components. The result of the fit, including the final photometic model for UGC 4721, can be seen in \ref{fig:model_tuning}. The secondary components have been accounted for well, and the model has a sensible reduced chi-squared value of \comment{CHISQ OF EXAMPLE FIT}.
