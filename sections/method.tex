...
% The \textit{stellar mass complete sample} defined by \citet{Hart2017:1708.04628v1} has the following criteria:
...
Once this hand-picked sample was completed, the remaining galaxies from the initial two sub-samples were re-activated, as well as a repeat of the first sub-sample (hereafter the \texit{validation subset}) to measure volunteer consistency. Time constraints meant that as of the time of writing, only these three batches of galaxies were run through the project.
